...
export default function SweetItem({ sweet, quantity, onQuantityChange }: SweetItemProps) {
  ...
  return (
    <div
      className={`bg-white p-4 md:p-6 rounded-xl shadow-sm border transition-all duration-300 hover:shadow-md
    ...
    >
      ...
      <div className="flex flex-col space-y-4">
        <div className="flex-1">
          <div className="flex items-start justify-between mb-2">
            <h3
              ...
              className="text-base md:text-lg font-semibold text-gray-800 leading-tight pr-2"
            >
              {sweet.name}
            </h3>
            <span
              className="text-xs px-2 py-1 bg-beige-100 text-beige-800 rounded-full whitespace-nowrap font-medium"
        ...
        {showTip && (
          <div className="text-xs text-gray-500 text-center animate-fadeIn bg-primary-50 p-2 rounded-md border border-primary-200">
